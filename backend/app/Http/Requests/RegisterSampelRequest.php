...
class RegisterSampelRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'reg_kode_provinsi' => 'required|integer|exists:labkes.provinsi,id',
            'reg_kode_kota' => 'required|integer|exists:labkes.kota,id',
            'reg_kode_kecamatan' => 'nullable|integer|exists:labkes.kota,id',
            'reg_kode_kelurahan' => 'nullable|integer|exists:labkes.kota,id',
            'reg_rt' => 'nullable',
            'reg_rw' => 'nullable',
