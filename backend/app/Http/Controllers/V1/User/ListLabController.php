...
class ListLabController extends Controller
{
    protected $role_id;
    protected $model;
    public function __construct()
    {
        $this->role_id = RoleEnum::LABORATORIUM()->getIndex();
        $this->model = User::query()->where('role_id', $this->role_id);
    }
    ...
    public function __invoke(Request $request)
    {
        ...
        $data = UserLabResource::collection($this->model->skip(($page - 1) * $perpage)->take($perpage)->get());
