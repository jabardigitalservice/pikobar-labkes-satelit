...
class Sampel extends Model
{
    ...
    public function scopeSelectCustom($query)
    {
        return $query->select(
            ...
            "register.fasyankes_pengirim", "register.fasyankes_pengirim as instansi_pengirim",
            "register.nama_rs", "register.nama_rs as instansi_pengirim_nama",
            "register.sumber_pasien", "pasien.status", "register.kunjungan_ke as swab_ke",
            "register.tanggal_kunjungan as tanggal_kunjungan", "pasien.nama_lengkap",
            "pasien.kewarganegaraan", "pasien.nik", "pasien.tanggal_lahir",
            "provinsi.id AS kode_provinsi", "provinsi.nama AS nama_provinsi",
            "kota.id AS kota_id", "kota.nama AS kota_nama", "kota.id AS kode_kabupaten",
            "kota.nama AS nama_kabupaten", "kecamatan.id AS kecamatan_id",
            "kecamatan.id AS kode_kecamatan", "kecamatan.nama AS kecamatan",
            "kecamatan.nama AS kecamatan_nama", "kelurahan.id AS kode_kelurahan",
            "kelurahan.nama AS kelurahan", "kelurahan.nama AS nama_kelurahan",
            "pasien.alamat_lengkap", "pasien.jenis_kelamin", "pasien.usia_tahun",
