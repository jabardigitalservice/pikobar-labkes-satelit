...
const routes = [
    ...
    {
        path: '/registrasi/mandiri/detail/:register_id/:pasien_id',
        name: 'registrasi.mandiri.detail',
    ...
    // Verifikasi
    { path: '/hasil-pemeriksaan/list-hasil-pemeriksaan', name: 'verifikasi.index.unverified', component: page('verifikasi/list-unverified.vue'), meta: { parentName: 'home' } },
    ...
    { path: '/hasil-pemeriksaan/import-excel', name: 'import Hasil Pemeriksaan', component: page('verifikasi/import-excel.vue'), meta: { parentName: 'verifikasi.index.unverified' } },
