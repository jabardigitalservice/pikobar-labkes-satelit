...
const routes = [
  ...
  { path: '/registrasi/WebSatelit', name: 'registrasi.WebSatelit', component: page('registrasi-WebSatelit/index.vue'), meta: {parentName: 'home'} },
  { path: '/registrasi/WebSatelit/tambah', name: 'registrasi.WebSatelit.tambah', component: page('registrasi-WebSatelit/tambah.vue'), meta: {parentName: 'registrasi.WebSatelit'} },
  { path: '/registrasi/WebSatelit/detail/:register_id/:pasien_id', name: 'registrasi.WebSatelit.detail', 
                    component: page('registrasi-WebSatelit/detail.vue'), 
                    meta: {parentName: 'registrasi.WebSatelit'} },
  { path: '/registrasi/WebSatelit/update/:register_id/:pasien_id', name:'registrasi.WebSatelit.update', meta: {parentName: 'registrasi.WebSatelit'}, component: page('registrasi-WebSatelit/update.vue')},
  { path: '/registrasi/WebSatelit/export-excel', name:'registrasi.WebSatelit.export-excel', component: page('registrasi-WebSatelit/export-excel.vue'), meta: {parentName: 'registrasi.WebSatelit'} },
  { path: '/registrasi/WebSatelit/import-excel', name:'registrasi.WebSatelit.import-excel', component: page('registrasi-WebSatelit/import-excel.vue'), meta: {parentName: 'registrasi.WebSatelit'} },
