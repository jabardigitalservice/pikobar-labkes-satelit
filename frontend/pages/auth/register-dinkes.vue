        ...
        <card>
          <form @submit.prevent="register" @keydown="form.onKeydown($event)">
            ...
            <div class="form-group row">
              <label class="col-md-3 col-form-label text-md-right">{{ $t("email") }}<span
                  style="color: red">*</span></label>
              <div class="col-md-8 form-group">
                <label type="email" name="email" class="form-control" readonly>
                  {{ this.email }}
                </label>
              </div>
            </div>
            ...
            <!-- Username -->
            <div class="form-group row">
              <label class="col-md-3 col-form-label text-md-right">Username<span style="color: red">*</span></label>
              <div class="col-md-8 form-group">
                <label type="email" name="email" class="form-control" readonly>
                  {{ this.username }}
                </label>
            ...
            <!-- Password -->
            <div class="form-group row">
              <label class="col-md-3 col-form-label text-md-right">{{ $t("password") }}<span
                  style="color: red">*</span></label>
              <div class="col-md-8 form-group">
            ...
            <div class="form-group row">
              <label class="col-md-3 col-form-label text-md-right">{{ $t("confirm_password")
                }}<span style="color: red">*</span></label>
              <div class="col-md-8 form-group">
                <input v-model="form.password_confirmation" :class="{
                  ...
                  required />
                <span class="prefix-icon-password" :class="showRePassword ? 'fa fa-eye' : 'fa fa-eye-slash'" @click="showRePassword = !showRePassword" />
                <has-error :form="form" field="password_confirmation" />
              </div>
            </div>

            <div class="form-group row">
              <div class="col-md-8 form-group offset-md-3 d-flex">
                <!-- Submit Button -->
