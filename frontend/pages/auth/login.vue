    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div> 
          <div>
            ...
            <h3>Welcome to Pikobar Lab</h3>
            <p>Silakan Login Menggunakan Username dan Password anda</p>
            <form @submit.prevent="login" @keydown="form.onKeydown($event)">
                <div class="form-group">
                    <input v-model="form.email" :class="{ 'is-invalid': form.errors.has('email') }" type="email" name="email" class="form-control" placeholder="Email">
