                ...
                <Ibox title="Registrasi Mandiri">
                    <form @submit.prevent="submitForm" @keydown="form.onKeydown($event)">
                        <div id="smartwizard-default">
                            <ul>
                                <li><a href="#sw-default-step-1">Identitas Pengirim<small class="d-block">Identitas
                                            Pengirim Spesimen</small></a></li>
                                <li><a href="#sw-default-step-2">Identitas Pasien<small class="d-block">Informasi
                                            Pasien</small></a></li>
                                <li><a href="#sw-default-step-3">Tanda dan Gejala<small class="d-block">Gejala
                                            Pasien</small></a></li>
                                <li><a href="#sw-default-step-4">Pemeriksaan Penunjang<small class="d-block">Pemeriksaan
                                            Pasien</small></a></li>
                                <li><a href="#sw-default-step-5">Riwayat Kontak<small class="d-block">Riwayat Kontak
                                            Pasien</small></a></li>
                                <li><a href="#sw-default-step-6">Penyakit Penyerta<small class="d-block">Komorbid
                                            Pasien</small></a></li>
                                <li><a href="#sw-default-step-7">Sampel<small class="d-block">Nomor
                                            Sampel</small></a></li>
                            </ul>
                            <div class="p-3">
                                <div id="sw-default-step-1">
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-md-6" :class="{ 'is-invalid': form.errors.has('nomor_register') }">
                                            <input class="multisteps-form__input form-control" type="text" name="reg_no"
                                                placeholder="Nomor Registrasi" required v-model="form.nomor_register" disabled />
                                            <has-error :form="form" field="nomor_register" />
                                        </div>
                                    </div>
                                    <div class="form-group row mt-4">
                                        <label class="col-md-2" for="dinkespengirim">Dinkes Pengirim</label>
                                        <select :class="{ 'is-invalid': form.errors.has('nomor_register') }" class="multisteps-form__input form-control col-md-6" style="margin-left:15px" id="dinkespengirim"
                                            name="reg_dinkes_pengirim" onchange="dinkesotheroptionselect(this);" v-model="form.reg_dinkes_pengirim">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input class="multisteps-form__input form-control" type="text"
                                                    id="daerahlain" name="daerahlain"
                                                    placeholder="Masukan Dinkes Terkait" v-model="form.daerahlain" />
                                                <has-error :form="form" field="daerahlain" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-check-inline"
                                                ...
                                                <input class="form-check-input" type="radio" v-model="form.reg_fasyankes_pengirim"
                                                    name="reg_fasyankes_pengirim" id="fasyanrs" value="Rumah Sakit">
                                                <label class="form-check-label" for="fasyanrs">Rumah Sakit</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" v-model="form.reg_fasyankes_pengirim"
                                                    name="reg_fasyankes_pengirim" id="fasyandinkes" value="Dinkes">
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <select class="multisteps-form__input form-control col-md-6"
                                                ...
                                                id="rsfasyankes" name="reg_nama_rs"
                                                v-model="reg_nama_rs"
                                                onchange="rsotheroptionselect(this);">
                                                <option value="RSUP Dr. Hasan Sadikin">RSUP Dr. Hasan Sadikin
                                                </option>
                                                <option value="RSP Dr. H.A. Rotinsulu">RSP Dr. H.A. Rotinsulu
                                                </option>
                                                ...
                                                <option value="RS Bhayangkara Sartika Asih">RS Bhayangkara Sartika
                                                    Asih</option>
                                                <option value="RSUD dr. Soekardjo">RSUD dr. Soekardjo</option>
                                                <option value="RSUD SMC Kab. Tasik">RSUD SMC Kab. Tasik</option>
                                                <option value="RS Paru Prov. Jabar Sidawangi">RS Paru Prov. Jabar
                                                    Sidawangi</option>
                                                ...
                                                <option value="RS Lanud dr. M. Salamun">RS Lanud dr. M. Salamun
                                                </option>
                                    ...
                                    <div class="mt-4" id="inputrslain" style="display: none;">
                                        <div class="form-group row">
                                            <label class="col-md-2"></label>
                                            <div class="col-md-6">
                                                <input :class="{ 'is-invalid':form.errors.has('reg_nama_rs_lainnya') }" class="multisteps-form__input form-control" type="text"
                                                    name="reg_nama_rs_lainnya"
                                                    v-model="form.reg_nama_rs_lainnya"
                                                    placeholder="Nama Rumah Sakit / Fasyankes" />
                                                <has-error :form="form" field="reg_nama_rs_lainnya"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <input v-model="form.reg_no_rekammedis" :class="{ 'is-invalid': form.errors.has('reg_no_rekammedis') }" class="multisteps-form__input form-control" type="text"
                                                name="reg_no_rekammedis" placeholder="Nomor Rekam Medis" />
                                            <has-error :form="form" field="reg_no_rekammedis"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <input v-model="form.reg_nama_dokter" :class="{ 'is-invalud': form.errors.has('reg_nama_dokter') }" class="multisteps-form__input form-control" type="text"
                                                name="reg_nama_dokter" placeholder="Dokter Penanggung Jawab" />
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <input v-model="form.reg_telp_fas_pengirim" :class="{ 'is-invalid': form.errors.has('reg_telp_fas_pengirim') }" class="multisteps-form__input form-control" type="text"
                                                name="reg_telp_fas_pengirim"
                                                placeholder="Nomor Telp  Fasyankes Pengirim / Dokter yang merawat" />
                                            <has-error :form="form" field="reg_telp_fas_pengirim"/>
                                        </div>
                                    </div>
                                ...
                                <div id="sw-default-step-2">
                                    <div class="form-group row mt-4">
                                        <label class="col-md-2">Kewarganegaraan <span
                                                style="color:red;">*</span></label>
                                        <div class="col-md-6">
                                            <select v-model="form.reg_kewarganegaraan" :class="{ 'is-invalid':form.errors.has('reg_kewarganegaraan') }" class="multisteps-form__input form-control col-md-6"
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <input v-model="form.reg_nama_pasien" :class="{ 'is-invalid': form.errors.has('reg_nama_pasien') }" class="multisteps-form__input form-control" type="text"
                                    ...
                                    <div class="form-group row mt-4">
                                        <label class="col-md-2">Nomor Identitas <span
                                                style="color:red;">*</span></label>
                                        <div class="col-md-6">
                                            <div class="form-check form-check-inline" :class="{ 'is-invalid': form.errors.has('reg_jenisidentitas') }">
