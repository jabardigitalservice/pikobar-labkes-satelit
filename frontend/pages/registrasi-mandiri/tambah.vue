                            ...
                            <div class="p-3">
                                <div id="sw-default-step-1">
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <select class="multisteps-form__input form-control col-md-6" style="margin-left:15px" id="dinkespengirim"
                                            name="reg_dinkes_pengirim" onchange="dinkesotheroptionselect(this);">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input class="multisteps-form__input form-control" type="text"
                                                    ...
                                                    placeholder="Masukan Dinkes Terkait" />
                                            </div>
                                        </div>
                                    </div>
