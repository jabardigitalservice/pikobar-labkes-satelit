          ...
          <Ibox title="Identitas Pasien">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8" :class="{ 'is-invalid': form.errors.has('reg_kota') }">
                <select class="form-control" type="text" name="reg_kota" placeholder v-model="form.reg_kota">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8" :class="{ 'is-invalid': form.errors.has('reg_kecamatan') }">
                <input v-model="form.reg_kecamatan" class="form-control" type="text" name="reg_kecamatan" />
    ...
    async asyncData({
      ...
      return {
        form: new Form({
          ...
          reg_rt: data.reg_rt ? parseInt(data.reg_rt) : null,
          reg_rw: data.reg_rw ? parseInt(data.reg_rw) : null,
