    ...
    <tr>
        ...
        <td v-if="config.has_action">
            <nuxt-link :to="`/registrasi/sampel/detail/${item.register_id}/${item.pasien_id}`"
                class="mb-1 btn btn-success btn-sm"><i class="fa fa-eye"></i></nuxt-link>
            <nuxt-link :to="`/registrasi/sampel/update/${item.register_id}/${item.pasien_id}`"
                class="mb-1 btn btn-primary btn-sm"><i class="fa fa-edit"></i></nuxt-link>
            <a href="#" class="mb-1 btn btn-danger btn-sm" @click="deleteData(item.register_id, item.pasien_id)"><i
